package com.kymatic.authservice.config;

import com.kymatic.authservice.multitenancy.JwtTenantResolver;
...
public class SecurityConfig {
    ...
    public SecurityConfig(JwtTenantResolver jwtTenantResolver) {
